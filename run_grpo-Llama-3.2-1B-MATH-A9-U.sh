...
experiment_name="Llama-3.2-1B-MATH-A9-U-TA-GRPO"
...
python test.py --repo_id lhkhiem28/${experiment_name} --folder_path checkpoints/${project_name}/${experiment_name}/global_step_406/actor/huggingface
